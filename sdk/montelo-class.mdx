...
This property is an instance of the Mistral class. It allows you to interact with the Mistral API, and Montelo will automatically log all relevant interactions.
