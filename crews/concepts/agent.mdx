...
| Property                            | Type       | Description                                                                                  | Supports Variables |
| ----------------------------------- | ---------- | -------------------------------------------------------------------------------------------- | ------------------ |
...
| `tools`                             | _Tool[]_   | Functions that the agent can use to perform tasks ([guide](/crews/concepts/task))            | No                 |
| `stepCallback`                      | _Function_ | A function that is called after each step of the agent. E.g. you can use this to log outputs | N/A                |
...
Now, instantiate the Agent class with its configuration. Here is an example using all the properties:
...
You can now use this agent in any Crew!
