...
Now you have to setup you're montelo client ([guide](/general/quickstart)).
...
- The LLM **model** which powers the agent (NOTE: only OpenAI models are currently supported).
